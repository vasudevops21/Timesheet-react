...
function Roles ({ locale, setLocale })  {
  ...
  const AddRoleModal = ({ isVisible, onClose, onSave }) => {
    ...
    const isRoleNameDuplicate = (roleName, roles, newRoles) => {
      const isDuplicateInDefaultRoles = roles.some(
        (role) => role.name.toLowerCase() === roleName.toLowerCase()
      );
      const isDuplicateInCustomRoles = newRoles.some(
        (role) => role.name.toLowerCase() === roleName.toLowerCase()
      );
      ...
      if (role.trim() && department.trim()) {
        if (
          isRoleNameDuplicate(
            role,
            roles,
            newRoles.filter((_, index) => index !== editingRoleIndex)
          )
        ) {
        ...
        <div className="modal-content-roles">
            ...
            <div className="">
              ...
              >
                <option
                  disabled
                  value=""
                  className="setting_add_department_option"
                >
                  Choose Role
                </option>
          ...
          <div className="button-group d-flex gap-4 justify-content-center ms-4">
            <div className="roles_add_button d-flex">
              <button
                className="add_button1 btn btn-sm px-4 py-2"
        ...
        <div className="modal-overlay">
          <div className="modal-content-roles">
            ...
            <div className="add_role_department">
              ...
              <div className="add_department">
                <label className="setting_add_department_input">
                  Department
                </label>
                <input
                  className="setting_placeholder"
            ...
            <div className="button-group d-flex gap-4 justify-content-center ms-4">
              <div className="roles_add_button d-flex">
                <button
                  className="edit_button1 btn px-3"
                  onClick={handleSaveClick}
                >
              ...
              <div className="roles_cancel_buton">
                <button
                  className="edit_cancel_button btn px-3"
                  onClick={onClose}
                >
                  <MdOutlineCancel className="fs-4 me-2" />
                  cancel
              ...
              <div className="text-end me-5">
                <div className="content-area">
                  <div className="d-flex justify-content-end">
                    <div
                      className="add-btn d-flex setting_role_create"
                    ...
                    >
                      ...
                      <div className="add_button_text">
                        <FormattedMessage id="createrole" />
                      </div>
                    </div>
                  </div>
                  <AddRoleModal
                  ...
                  {roles.map((role, index) => (
                    <div key={index} className="card1 shadow mb-3 pt-2">
                      ...
                      >
                        ...
                        {role.name === "Administrator" ? (
                          <p className="disabled">Configure Permission</p>
                        ) : (
                          <div>
                            <p
                              className="permission"
                              onClick={() =>
                                handleConfigurePermission(role.name)
                              }
                            >
                    ...
                    newRoles.map((role, index) => (
                      <div key={index} className="card1 shadow mb-3 pt-2 ">
                        <div className="edit-role-delete-div justify-content-end text-end">
                          <button
                            className="edit-role-button fs-5"
                          ...
                          >
                            ...
                            >
                              <path
                                d="M14.7825 6.02992L13.0275 7.77742L10.215 4.96492L11.97 3.21742C12.2625 2.92492 12.75 2.92492 13.0275 3.21742L14.7825 4.97242C15.075 5.24992 15.075 5.73742 14.7825 6.02992ZM2.25 12.9374L9.795 5.38492L12.6075 8.19742L5.0625 15.7499H2.25V12.9374ZM12.465 3.77992L11.31 4.93492L13.065 6.68992L14.22 5.53492L12.465 3.77992ZM11.52 8.24992L9.75 6.47992L3 13.2449V14.9999H4.755L11.52 8.24992Z"
                                fill="white"
                              />
                            </svg>
                          </button>
                          <button
                            className="delete-role-button fs-5"
                            data-bs-toggle="modal"
                            data-bs-target="#conformationdeleteModal"
                          ...
                          {/* project popup start */}
                          <div
                            className="modal setting_popup_box"
                            id="conformationdeleteModal"
                            tabindex="-1"
                            aria-labelledby="conformationdeleteModalLabel"
                            aria-hidden="true"
                          >
                            <div className="modal-dialog setting_popup_box_modal_dialog">
                              <div className="modal-content setting_popup_box_modal_contect">
                                <div
                                  class="modal-body"
                                  id="conformationdeleteModalLabel"
                                >
                                  <div
                                    className="setting_role_delete_confirm_close"
                                  ...
                                  <div className="d-flex mt-3 ">
                                    <div className="setting_role_delete_svg ">
                                      ...
                                      >
                                        ...
                                        <path
                                          d="M17 68C17 65.2386 19.2386 63 22 63H79C81.7614 63 84 65.2386 84 68V122C84 130.284 77.2843 137 69 137H32C23.7157 137 17 130.284 17 122V68Z"
                                          fill="white"
                                          stroke="#FF7F7F"
                                          stroke-width="14"
                                          mask="url(#path-1-inside-1_4035_16032)"
                                        />
                                        <rect
                                          x="0.254395"
                                          y="52.4956"
                                          ...
                                          height="9.04959"
                                          rx="4.5248"
                                          transform="rotate(-40.6555 0.254395 52.4956)"
                                          fill="#FF7F7F"
                                        />
                                        <mask
                                          id="path-3-inside-2_4035_16032"
                                          fill="white"
                                        >
                                        ...
                                        <path
                                          d="M6.55532 34.7797C3.19652 30.8686 3.64425 24.9752 7.55537 21.6164L27.2111 4.73636C31.1222 1.37756 37.0156 1.82529 40.3744 5.7364L33.2253 15.8304C33.1048 15.6902 32.8935 15.6741 32.7533 15.7946L17.6494 28.7655C17.5092 28.886 17.4931 29.0973 17.6135 29.2375L6.55532 34.7797ZM41.9042 16.7272L17.1888 37.9524L41.9042 16.7272ZM19.7187 35.7798C15.8076 39.1386 9.91413 38.6908 6.55532 34.7797C3.19652 30.8686 3.64425 24.9752 7.55537 21.6164L17.6494 28.7655C17.5092 28.886 17.4931 29.0973 17.6135 29.2375C19.8929 31.8917 21.8544 33.9457 21.9946 33.8252L19.7187 35.7798ZM27.2111 4.73636C31.1222 1.37756 37.0156 1.82529 40.3744 5.7364C43.7332 9.64752 43.2855 15.5409 39.3744 18.8998L37.0984 20.8543C37.2387 20.7338 35.5046 18.4846 33.2253 15.8304C33.1048 15.6902 32.8935 15.6741 32.7533 15.7946L27.2111 4.73636Z"
                                          fill="#FF7F7F"
                                          mask="url(#path-3-inside-2_4035_16032)"
                                        />
                                        <rect
                                          x="41"
                                          y="81"
                                        ...
                                        <g clip-path="url(#clip0_4035_16032)">
                                          <path
                                            d="M61.1575 36.2083C62.9383 32.2042 66.0682 28.754 70.3654 26.7348C77.9057 23.1919 86.5872 25.1109 92.0175 30.8538L88.7848 33.9168C86.7117 31.7236 83.9993 30.2405 81.034 29.6788C78.0687 29.1172 75.0018 29.5056 72.2702 30.7888C69.1081 32.2746 66.7703 34.7983 65.4001 37.7385L74.0284 40.8504L59.4342 47.7078L52.5768 33.1135L61.1575 36.2083Z"
                                            fill="#FF7F7F"
                                          />
                                        </g>
                                        <defs>
                                          <clipPath id="clip0_4035_16032">
                                            <rect
                                              ...
                                              height="43"
                                              fill="white"
                                              transform="matrix(-0.905069 0.425264 0.425264 0.905069 82.918 5)"
                                            />
                                          </clipPath>
                                        </defs>
                                      </svg>
                                    ...
                                    <div className="confirmdelete_word">
                                      <h2 className="confirmdelete_word_h2">
                                        {" "}
                                        Delete Role{" "}
                                      </h2>
                                      <p className="confirmdelete_word_p">
                                ...
                                <div className="d-flex justify-content-center mb-5">
                                  <div
                                    className="button btn d-flex flex-row setting_role_delete_button "
                                    onClick={() => {
                                  ...
                                  >
                                    ...
                                    <div className="setting_role_delete_button_text ">
                                      Delete
                                    </div>
                                  </div>
                                  <div
                                    className="button btn d-flex flex-row setting_role_cancel_button "
                                    data-bs-dismiss="modal"
                                  >
                                    <svg
                                      xmlns="http://www.w3.org/2000/svg"
                                    ...
                                    {/* <BsFillArrowDownCircleFill className="timesheet-weekly-export-download-modal-footer-btn-download-icon" /> */}
                                    <div
                                      className="setting_role_cancel_button_text"
                                      data-bs-dismiss="modal"
                                    >
                                      Cancel
                                    </div>
